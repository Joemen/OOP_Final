public class Property{
	...
	public void set_prop(int role_id){
		if(role_id == 0){
			...
			this.is_tower_repair_rate = 1.5;
			this.is_discount = 1;
		}
		else if (role_id == 1){
			this.is_add_money_rate = 1.5;
			this.is_add_soldier_generate = 1;
			...
			this.is_add_money_rate = 1;
			this.is_add_soldier_generate = 1.5;
			this.is_tower_repair_rate = 1;
			this.is_discount = 1;
		}
		else if (role_id == 3){
			this.is_add_money_rate = 1;
			this.is_add_soldier_generate = 1.25;
			this.is_tower_repair_rate = 1.25;
			this.is_discount = 1;
		}
		else if (role_id == 4){
			this.is_add_money_rate = 1.25;
			this.is_add_soldier_generate = 1;
			this.is_tower_repair_rate = 1;
			this.is_discount = 0.85;
		}
		else if (role_id == 5){
			this.is_add_money_rate = 1.25;
			this.is_add_soldier_generate = 1.25;
