...
public class MunitionsFactory extends Functions{
    ...
    public MunitionsFactory(){
        setPrice(Constants.fee_one, Constants.fee_two, Constants.fee_three);
        setAddSoldier(Constants.munition_amount_one, Constants.munition_amount_two, Constants.munition_amount_three);
    }
