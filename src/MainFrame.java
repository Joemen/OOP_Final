...
public class MainFrame {
	...
	public static JMenuItem newGameMenuItem;
	public static JMenuItem historyMenuItemLeft ;
	public static JMenuItem historyMenuItemRight;
	...
	private void initialize() {
		...
		// history left
		historyMenuItemLeft = new JMenuItem("History(Left)");
		historyMenuItemLeft.setEnabled(false);
		historyMenuItemLeft.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				HistoryFrame historyframe = new HistoryFrame(0);
				historyframe.printHistoryLeft();
				historyframe.historyframe.setVisible(true);

			}
		});
		historyMenu.add(historyMenuItemLeft);
		
		// history right
		historyMenuItemRight = new JMenuItem("History(Right)");
		historyMenuItemRight.setEnabled(false);
		historyMenuItemRight.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				HistoryFrame historyframe = new HistoryFrame(1);
				historyframe.printHistoryRight();
				historyframe.historyframe.setVisible(true);

			}
		});
		historyMenu.add(historyMenuItemRight);
